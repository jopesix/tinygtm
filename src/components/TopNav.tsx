...
import { FileText, LayoutDashboard, LogOut, LogIn } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2" aria-label="TinyGTM home">
          ...
          <span className="font-semibold text-ink">
            ...
            <span className="text-zinc-400 font-normal"> · FAQs</span>
          </span>
        </Link>
        ...
        <nav className="flex items-center gap-1">
          ...
          >
            ...
            <span className="hidden sm:inline">New FAQ</span>
          </Link>
